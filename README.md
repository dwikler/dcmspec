...
[![dicom](https://img.shields.io/github/actions/workflow/status/dwikler/dcmspec/e2e.yml?label=dicom)](https://github.com/dwikler/dcmspec/actions/workflows/e2e.yml)
